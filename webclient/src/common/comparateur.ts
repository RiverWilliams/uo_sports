import {
  Activite, Actualite, CategorieSport, Creneau, Inscription, Lieu, Niveau, Personne, Responsable,
  Sport
} from "./model";
...
export namespace Comparateur {
  ...
  export namespace Personne {
    export function nom(a: Personne, b: Personne): number {
      return a.nom.localeCompare(b.nom);
    }

    export function prenom(a: Personne, b: Personne): number {
      return a.prenom.localeCompare(b.prenom);
    }

    export function nomPrenom(a: Personne, b: Personne): number {
      const n = nom(a, b);
      if (n != 0)
        return n;
      return prenom(a, b);
  ...
  export namespace Inscription {
    export function personneNomPrenom(a: Inscription, b: Inscription): number {
      return Personne.nomPrenom(a.personne, b.personne);
    }
  }
